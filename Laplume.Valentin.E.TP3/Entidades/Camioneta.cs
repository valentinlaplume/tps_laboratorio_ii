...
namespace Entidades
{
    public class Camioneta : Vehiculo, IAutomovil
    {
            ...
            : base (nombre, año, km, tipoCombustible, tipoTransmision, color, precio)
        {
            try
            {
                ultimoId = ManejadoraSql.GetIdMaxVehiculo("Camioneta");
                this.id = ultimoId + 1;
                ultimoId = this.id;
        ...
        /// </summary>
        public Camioneta(int id, EMarcaAutomovil marca, string nombre, int año, int km, ETipoCombustible tipoCombustible, ETipoTransmision tipoTransmision,
                 EColor color, float precio, int cantidadPuertas)
                : base(nombre, año, km, tipoCombustible, tipoTransmision, color, precio)
        {
            this.id = id;
